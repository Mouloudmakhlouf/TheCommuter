...
async function calculateSplit() {
  ...
  calcBtn.innerText = "⏳ Fetching Live Routes...";
  ...
  try {
    ...
    data.routes.forEach((route, index) => {
      ...
      // THE FIX: Check every possible payment method TollGuru returns
      if (route.summary.tolls) {
          tolls = parseFloat(route.summary.tolls.cashCost || route.summary.tolls.tagCost || route.summary.tolls.licensePlateCost || 0);
      }
      ...
      routeCard.innerHTML = `
        ...
        <p style="margin: 2px 0; font-size: 14px;"><b>Distance:</b> ${finalDistance.toFixed(1)} km | <b style="${finalTolls > 0 ? 'color:#b91c1c;' : 'color:#166534;'}">Tolls: ${finalTolls.toFixed(2)} PLN</b></p>
